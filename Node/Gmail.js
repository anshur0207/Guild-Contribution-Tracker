  ...
  readInboxContent = async (searchText) => {
    ...
    for (let i = 0; i < threadId.length; i++) {
      ...
      if (!oldMail) {
        ...
        if (loc === "contributions123@gmail.com") {
          if (mimeType == "text/plain") {
                  ...
                  if (!oldUser) {
                    ...
                    transporter.sendMail(mailOptions, function (error, info) {
                      if (error) {
                        ...
                        console.log(
                          " Contribution Submission Email sent: " +
                            info.response
                        );
                      }
                    });
            ...
            console.log(i + " Wrong format : " + mimeType + " " + s);
            ...
            transporter.sendMail(mailOptions, function (error, info) {
              if (error) {
                ...
                console.log(
                  " Wrong format email sent: " + s + "------ " + info.response
                );
              }
            });
          }
