          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-12">
              <div className="work-process">
                ...
                <div className="step-num-box">
                  <div className="step-icon"><span><img src={Register} alt='image'></img></span>
                  </div>
            ...
            <div className="col-lg-4 col-md-12 md-mt-5">
              <div className="work-process">
                ...
                <div className="step-num-box">
                  <div className="step-icon"><span><img src={Submit} alt='image' style={{height:"5rem"}}/></span>
                  </div>
            ...
            <div className="col-lg-4 col-md-12 md-mt-5">
              <div className="work-process">
                <div className="step-num-box">
                  <div className="step-icon"><span><img src={Reward} alt='image' style={{height:"5rem"}}/></span>
                  </div>
